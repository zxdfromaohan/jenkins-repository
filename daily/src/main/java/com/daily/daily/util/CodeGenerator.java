...
//        dsc.setUrl("jdbc:mysql://localhost:3306/" + prefix + moduleName + "?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8");
        dsc.setUrl("jdbc:mysql://123.57.21.14:3306/mymallEmpty0629?useUnicode=true&characterEncoding=UTF-8&useAffectedRows=true&allowMultiQueries=true");
...
//        strategy.setSuperEntityColumns("id", "gmt_create", "gmt_modified");
	...
	public static String scanner(String tname) {
        Scanner scanner = new Scanner(System.in);
        StringBuilder help = new StringBuilder();
        help.append("请输入" + tname + "：");
        ...
        throw new MybatisPlusException("请输入正确的" + tname + "！");
    }
}
